...
import { Grid3X3, Loader2, Map as MapIcon } from "lucide-react";
...
interface LaboratoriesContentProps {
  labs: Lab[];
}

export const LaboratoriesContent = ({ labs }: LaboratoriesContentProps) => {
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex justify-between items-center mb-8">
            <p className="text-gray-500">
              {labs.length} laboratorio{labs.length !== 1 ? "s" : ""} miembro
              {labs.length !== 1 ? "s" : ""}
            </p>
